...
export default function QuoteForm() {
  return (
    <section className="relative bg-[#001a33] text-white py-16 px-6 md:px-0 overflow-hidden">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 shadow-2xl rounded-3xl overflow-hidden">
        {/* Left Column - Info */}
        <div className="bg-gradient-to-br from-[#002244] via-[#003366] to-[#004080] p-12 flex flex-col justify-center">
          <h2 className="text-4xl md:text-5xl font-extrabold text-[#FFC107] mb-6">
            Get Your Free Moving Quote
          </h2>
          <p className="text-gray-200 text-lg italic mb-8">
            “Safe, Reliable & On-Time Moving Solutions You Can Trust.”
          </p>

          <ul className="space-y-5 text-gray-100">
            <li className="flex items-center space-x-3">
              <FaShieldAlt className="text-[#FFC107] text-xl" />
              <span>Trusted and Secured Relocation Services</span>
            </li>
            <li className="flex items-center space-x-3">
              <FaClock className="text-[#FFC107] text-xl" />
              <span>On-Time Pickup & Delivery</span>
            </li>
            <li className="flex items-center space-x-3">
              <FaSmile className="text-[#FFC107] text-xl" />
              <span>Professional & Friendly Team</span>
            </li>
            <li className="flex items-center space-x-3">
              <FaCheckCircle className="text-[#FFC107] text-xl" />
  ...
  >
    ...
    <input
      type="hidden"
      name="_subject"
      value="New Quote Request - Avtar Packers & Movers"
    />
    ...
    {/* Moving From */}
    <div className="flex items-center border rounded-lg px-3 bg-gray200 focus-within:ring-2 focus-within:ring-[#FFC107]">
    ...
    <div className="text-center">
      <button
        type="submit"
        className="px-10 py-3 cursor-pointer bg-gradient-to-r from-[#FFC107] to-[#FFD54F] text-black font-semibold text-lg 
