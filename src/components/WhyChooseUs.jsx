    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h2 className="text-center text-4xl sm:text-6xl md:text-6xl font-bold tracking-wider mb-10">
          WHY <span className="text-red-800">AVATAR PACKERS AND MOVERS</span>
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center border-t border-b border-gray-500 py-10">
          ...
          <div className="order-2 md:order-2 text-gray-200 leading-relaxed text-lg space-y-4">
            <p>
              ...
              we deliver <span className="text-white">safe, fast, and premium relocation</span> services.  
            ...
            <p>
              ...
              <span className="text-red-800"> complete peace of mind</span>. Every relocation is 
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center border-b border-gray-500 py-10 mt-10">
          ...
          <div className="order-2 md:order-1 text-gray-200 leading-relaxed text-lg space-y-4">
            <p>
              ...
              <span className="text-red-800"> home, office, and vehicle shifting</span>.  
              Choosing us means choosing <span className="text-white font-semibold">reliability, trust, 
              and on-time delivery</span>. Our customized solutions ensure your move is smooth from start 
              to finish — 
              we make relocation <span className="text-red-800">simple, safe, and stress free</span>.
            </p>
            <p>
              We believe every move is unique, which is why we offer 
              <span className="text-white"> tailored packages</span> to suit your budget and requirements.  
              ...
              With <span className="text-red-800 font-semibold">Avatar Packers And Movers</span>, you don’t just move — 
              you experience <span className="text-white">excellence, care, and trust</span>.
            </p>
          </div>
